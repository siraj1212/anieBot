...
async def _(event):
    ...
    if not event.reply_to_msg_id:
        ...
        if "Wolfram Alpha did not understand" in res.text:
            await event.reply(
                "Sorry, Amelia's AI systems could't recognized your question.."
            )
            return
            ...
            if "results" in r:
                ...
                if transcript_response != "":
                    ...
                    if "Wolfram Alpha did not understand" in res:
                        answer = (
                            "I'm sorry Amelia's AI system can't undestand your problem"
                        )
                    else:
                        answer = res.text
                    try:
                    ...
                    try:
                        answer = "Sorry, Amelia's AI system can't understand you.."
                        tts = gTTS(answer, tld="com", lang="en")
                        tts.save("results.mp3")
                    except AssertionError:
                        return
